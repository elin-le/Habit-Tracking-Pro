        ...
        >
            ...
            <div className="hidden md:flex items-center gap-3 shadow-sm px-6 lg:px-7 py-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        <span className={lang === "EN" ? "text-violet-700" : "text-violet-300"}>EN</span>
                        <span className="text-violet-200 font-normal">|</span>
                        <span className={lang === "VI" ? "text-violet-700" : "text-violet-300"}>VI</span>
                    </button>
                    ...
                    >
                        <span className="absolute left-1.5 top-1/2 -translate-y-1/2 text-yellow-400"><SunIcon /></span>
                        <span className="absolute right-1.5 top-1/2 -translate-y-1/2 text-violet-400"><MoonIcon /></span>
                        <span className={[
