      ...
      <div className="flex flex-wrap gap-6">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {categories.map((cat) => (
              <FilterChip key={cat.id} active={selectedCategory === cat.id} onClick={() => onCategoryChange(cat.id)}>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            <FilterChip active={!selectedPriority} onClick={() => onPriorityChange(null)}>{t("habit_filter.pri-0")}</FilterChip>
