...
import { Target, Zap, Award, CheckCircle2, Plus, Search, SlidersHorizontal } from "lucide-react";
...
const SummaryCard: React.FC<{
    ...
    >
        <div className={`w-10 h-10 sm:w-11 sm:h-11 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0 ${iconClass}`}>
            {icon}
        </div>
        <div className="min-w-0">
            ...
            <p className="text-xs opacity-60 font-semibold mt-1 truncate">
                {label}
            </p>
        </div>
    </button>
